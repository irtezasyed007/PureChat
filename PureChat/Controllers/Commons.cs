...
namespace Datalayer
{
	class Common
	{
		private readonly static string database = "purechat";
		private readonly static string _conString = String.Format("server={0};User Id={1};password={2};database={3}", "localhost", "root", "csi1", database);
